...
import pageBackground from "./../assets/Images/ContactPage/ContactPagePicture.png";

const ContactPage = () => {
  return (
    <section className="min-h-screen min-w-screen bg-cover" style={{backgroundImage: `url(${pageBackground})`}}>
